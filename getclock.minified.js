...
css_editor = false;
//.tos_main p/ color
css_property_amanecer = ".tos_main";
css_color_amanecer = "red";

css_property_dia = ".tos_main";
css_color_dia = "white";

css_property_tarde = ".tos_main";
css_color_tarde = "white";

css_property_anochecer = ".tos_main";
css_color_anochecer = "white";

css_property_noche = ".tos_main";
